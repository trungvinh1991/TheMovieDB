...
- (void)setScrollingDirection:(SVInfiniteScrollingDirection)scrollingDirection {
    self.scrollingDirection = scrollingDirection;
    
    CGRect rect = CGRectMake(0, self.scrollView.contentSize.height, self.scrollView.bounds.size.width, SVInfiniteScrollingViewHeight);
    if (self.scrollingDirection == SVInfiniteScrollingDirectionHorizontal) {
        rect = CGRectMake(self.scrollView.contentSize.width, 0, SVInfiniteScrollingViewHeight, self.scrollView.bounds.size.height);
    }
    self.frame = rect;
    self.originalBottomInset = self.scrollView.contentInset.right;
}
#pragma mark -
